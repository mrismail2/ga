...
const PHASE5_COMMON = ['attendance', 'exams', 'results', 'notifications'];
const LIVE_NAV_KEYS = Object.freeze({
  superadmin: Object.freeze(['dashboard', 'schoolonboarding', 'advisor', 'simulator', 'students', 'teachers', 'classes', 'lessons', 'messages', 'management', 'provisioning', ...PHASE5_COMMON, 'finance', 'incidents', 'reports', 'settings']),
  schooladmin: Object.freeze(['dashboard', 'advisor', 'simulator', 'students', 'teachers', 'classes', 'lessons', 'management', 'provisioning', 'messages', ...PHASE5_COMMON, 'finance', 'incidents', 'reports', 'settings']),
  teacher: Object.freeze(['dashboard', 'classes', 'lessons', 'messages', 'attendance', 'exams', 'results', 'incidents', 'reports', 'notifications', 'settings']),
  accountant: Object.freeze(['dashboard', 'finance', 'reports', 'notifications', 'settings']),
  parent: Object.freeze(['dashboard', 'attendance', 'exams', 'results', 'finance', 'incidents', 'notifications', 'settings']),
  student: Object.freeze(['dashboard', 'messages', 'attendance', 'exams', 'results', 'finance', 'notifications', 'settings']),
});
