            ...
            <View style={[styles.card, { backgroundColor: c.surface, borderColor: c.line }]}>
              {method === 'staff' ? (
                <>
                  ...
                  <TouchableOpacity onPress={() => goForgot('staff')} style={{ alignSelf: 'center', marginTop: 14 }}>
                ...
                <>
                  ...
                  <TouchableOpacity onPress={() => goForgot(method)} style={{ alignSelf: 'center', marginTop: 14 }}>
                    <Text style={[styles.link, { color: c.blue }]}>Ma illowday furaha sirta?</Text>
                  </TouchableOpacity>
