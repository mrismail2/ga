...
export default function AuthFlow() {
  ...
  const [forgotMethod, setForgotMethod] = useState('staff');
  ...
  if (screen === 'forgot') return <ForgotPasswordScreen initialMethod={forgotMethod} goLogin={() => setScreen('login')} />;
  return <LoginScreen goForgot={(method = 'staff') => { setForgotMethod(method); setScreen('forgot'); }} />;
}
