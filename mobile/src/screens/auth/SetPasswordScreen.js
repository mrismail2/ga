        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          <View style={styles.wrap}>
            <View style={styles.brand}>
              <Logo size={50} />
              <Text style={[styles.title, { color: c.ink }]}>{isInvite ? 'Ku biir Kobciye' : 'Deji furaha cusub'}</Text>
              ...
              <TouchableOpacity style={[styles.btn, styles.btnRow, { backgroundColor: c.blue, marginTop: 22, opacity: busy ? 0.7 : 1 }]}
                ...
                {busy ? <LoadingDots color="#fff" size={7} gap={5} /> : (
                  <>
                    ...
                    <Text style={styles.btnTxt}>{isInvite ? 'Deji Furaha & Ku biir' : 'Kaydi Furaha Cusub'}</Text>
                  </>
                )}
              </TouchableOpacity>
            </View>
