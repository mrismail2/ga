...
export const ROLES = {
  superadmin: {
    ...
    nav: ['dashboard', 'schoolonboarding', 'advisor', 'simulator', 'students', 'teachers', 'classes', 'attendance', 'exams', 'results', 'finance', 'billing', 'lessons', 'incidents', 'notice', 'reports', 'notifications', 'provisioning', 'permissions', 'messages', 'settings'],
  },
  schooladmin: {
    key: 'schooladmin', label: 'School Admin', labelSo: 'Maamulaha Dugsiga',
    name: 'Faadumo Cali', avatar: 'FC', sub: 'Dugsiga Hidaayada · Gabiley',
    nav: withManagementNavigation('schooladmin', ['dashboard', 'advisor', 'simulator', 'students', 'teachers', 'classes', 'attendance', 'exams', 'results', 'finance', 'billing', 'lessons', 'incidents', 'notice', 'reports', 'notifications', 'provisioning', 'permissions', 'messages', 'settings']),
  },
  teacher: {
    ...
    nav: ['dashboard', 'classes', 'attendance', 'exams', 'results', 'lessons', 'incidents', 'reports', 'notifications', 'messages', 'settings'],
  },
  accountant: {
  ...
  parent: {
    ...
    nav: ['dashboard', 'attendance', 'exams', 'results', 'finance', 'incidents', 'notice', 'notifications', 'settings'],
  },
  student: {
    ...
    nav: ['dashboard', 'attendance', 'exams', 'results', 'finance', 'notice', 'notifications', 'messages', 'settings'],
  },
};
