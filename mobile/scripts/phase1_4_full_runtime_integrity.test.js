...
ok('ForgotPasswordScreen preserves the approved card/logo shell while adding required secure recovery',
  /<Logo/.test(forgotPasswordScreen) && /borderRadius: 22/.test(forgotPasswordScreen)
  && /AuthForgotPasswordPanel/.test(forgotPasswordScreen));
